...
#define CONF_STDIO_USART_MODULE  SERCOM3//SERCOM4//EDBG_CDC_MODULE
#define CONF_STDIO_MUX_SETTING   USART_RX_3_TX_0_XCK_1//USART_RX_3_TX_2_XCK_3//EDBG_CDC_SERCOM_MUX_SETTING
#define CONF_STDIO_PINMUX_PAD0   PINMUX_UNUSED//EDBG_CDC_SERCOM_PINMUX_PAD0
#define CONF_STDIO_PINMUX_PAD1   PINMUX_UNUSED//EDBG_CDC_SERCOM_PINMUX_PAD1
#define CONF_STDIO_PINMUX_PAD2   PINMUX_PA22C_SERCOM3_PAD0//PINMUX_PB10D_SERCOM4_PAD2	// TX//EDBG_CDC_SERCOM_PINMUX_PAD2
#define CONF_STDIO_PINMUX_PAD3	 PINMUX_PA21D_SERCOM3_PAD3//PINMUX_PB11D_SERCOM4_PAD3	// RX//EDBG_CDC_SERCOM_PINMUX_PAD3
